...
batch_size = 32
checkpoint_filepath = "../../model/classification/MobileNetV1_checkpoints.h5"
model_checkpoint_callback = tf.keras.callbacks.ModelCheckpoint(
    filepath=checkpoint_filepath,
    save_best_only=True
)

checkpoint_filepath1 = "../../model/classification/MobileNetV1_acc_checkpoints.h5"
...
ResNet = MobileNet(include_top=True, weights='imagenet',
...
model.save('../../model/classification/MobileNetV1.h5')
