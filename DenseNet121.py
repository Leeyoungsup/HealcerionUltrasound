...
batch_size = 32
checkpoint_filepath = "../../model/classification/DenseNet121_checkpoints.h5"
model_checkpoint_callback = tf.keras.callbacks.ModelCheckpoint(
    filepath=checkpoint_filepath,
    save_best_only=True
)

checkpoint_filepath1 = "../../model/classification/DenseNet121_acc_checkpoints.h5"
...
model.save('../../model/classification/DenseNet121.h5')
