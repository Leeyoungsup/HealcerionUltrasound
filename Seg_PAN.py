...
model = smp.PAN('mobilenet_v2', in_channels=3, classes=4).to(device)
...
# validation
    ...
    if MIN_loss > (val_running_loss/count):
        torch.save(model.state_dict(),
                   '../../model/segmentation/PAN_callback.pt')
...
plt.ylim([0, 1])
plt.legend()
plt.savefig('../../model/segmenatation/PAN.png')
torch.save(model.state_dict(),
           '../../model/segmentation/PAN.pt')
print('batch size= 4')
