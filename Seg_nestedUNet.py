...
model = smp.UnetPlusPlus('mobilenet_v2', in_channels=3, classes=4).to(device)
...
# validation
    ...
    if MIN_loss > (val_running_loss/count):
        torch.save(model.state_dict(),
                   '../../model/segmentation/NestedUNet_callback.pt')
...
plt.ylim([0, 1])
plt.legend()
plt.savefig('../../model/segmenatation/NestedUNet.png')
torch.save(model.state_dict(),
           '../../model/segmentation/NestedUNet.pt')
print('batch size= 4')
