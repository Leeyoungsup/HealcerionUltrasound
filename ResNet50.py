...
batch_size = 32
checkpoint_filepath = "../../model/classification/ResNet50_checkpoints.h5"
model_checkpoint_callback = tf.keras.callbacks.ModelCheckpoint(
    filepath=checkpoint_filepath,
    save_best_only=True
)

checkpoint_filepath1 = "../../model/classification/ResNet50_acc_checkpoints.h5"
...
model.save('../../model/classification/ResNet50.h5')
